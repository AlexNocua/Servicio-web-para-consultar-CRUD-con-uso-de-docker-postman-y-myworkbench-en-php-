$(document).ready(function () {
  ...
  if ($("#tabla")) {
    $.ajax({
      type: "GET",
      url: "/www/backend/mostrar-empleado.php",
          ...
          $("#Actualizar").on("click", function (e) {
            ...
            if (
              ...
              $.ajax({
                ...
                url: "/www/backend/actualizar-empleado.php",
  ...
  $("#form_agregar").on("submit", function (e) {
    ...
    if (
      ...
      $.ajax({
        ...
        url: "../backend/guardar-empleado.php",  // Actualizada la ruta para reflejar la estructura de carpetas
